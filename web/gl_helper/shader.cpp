...
GLuint Shader::CreateShaderProgram(const char *vertex_shader_text,
...
GLuint Shader::LoadShaderProgram(const char *vertex_shader_path,
  ...
  /* Craete program */
  return Shader::CreateShaderProgram(vertex_shader_code.c_str(),
